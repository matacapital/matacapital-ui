...
export type InputPropsType = InputCommonPropsType<HTMLInputElement> & {
  label: string;
  placeholder?: string;
  type?: InputType;
...
export type InputRadioPropsType = InputCommonPropsType<HTMLInputElement> & {
  legend: string;
...
export type InputSelectPropsType = InputCommonPropsType<HTMLSelectElement> & {
  label: string;
  placeholder: string;
  fields: ContentType[];
};

export type InputNumberPropsType = InputPropsType & {
  min: number | string;
  max: number | string;
};

export type InputFormPropsType = Omit<
  InputPropsType,
  | "leadingIcon"
  | "leadingText"
  | "trailingIcon"
...
export type InputFormTypeRadioType = InputRadioPropsType &
  Pick<InputFormPropsType, "id" | "state" | "value" | "onError" | "onSuccess">;

export type InputFormTypeSelectType = InputSelectPropsType &
  Pick<InputFormPropsType, "id" | "state" | "value" | "onError" | "onSuccess">;

export type InputFormTypeAllType<T> = Pick<
  InputFormPropsType,
